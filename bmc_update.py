...
def final_bmc(BMC_IP,USER,PWD,BMC_HPM,bmc_success_status):
    ...
    print("INFO: BMC Update Proceeding for ",BMC_IP)
    print("INFO: "+BMC_IP+" BMC Update v1.1")
    Status = ""
    LastStatus = ""
    verified = ""
    Update_Status=""
    ...
    if Completed == "Pass":
        ...
        time.sleep(10)
        print("\n**** INFO: "+BMC_IP+" BMC update completed. ****")
